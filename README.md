# DemoAPT
项目中使用第三方库越来越多使用apt技术，如DBflow、Dagger2、ButterKnife等。在编译时根据Annotation生成了相关的代码，给开发带来了很大的便利。感觉APT这项技术很炫酷，所以就有了这篇文章。
...
上面Example的代码放在github：https://github.com/taoweiji/DemoAPT.git。也推荐阅读dagger2、dbflow、ButterKnife等基于apt的开源项目代码。
